...
export class WRFProjection {
    constructor(map_proj, ref_lat, ref_lon, truelat1, truelat2, stand_lon, dx, dy, e_we, e_sn) {
    ...
    */
    ...
    to_parent_mass_ij(i, j, i_parent_start, j_parent_start, parent_grid_ratio) {
    ...
    to_child_corners_ij(i, j, i_parent_start, j_parent_start, parent_grid_ratio) {
        return [
    ...
    to_parent_corners_ij(i, j, i_parent_start, j_parent_start, parent_grid_ratio) {
        return [
