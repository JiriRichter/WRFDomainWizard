    ...
    onAdd: function (map) {
        ...
        this._cornerMarkers = {
            sw: L.marker(this._corners.sw, {
                icon: L.divIcon({ className: (this.options.editable ? 'wrf-domain-grid-corner cursor-nesw-resize' : 'wrf-domain-grid-corner') }),
            }),
            se: L.marker(this._corners.se, {
                icon: L.divIcon({ className: (this.options.editable ? 'wrf-domain-grid-corner cursor-nwse-resize' : 'wrf-domain-grid-corner') })
            }),
