...
WRFDomainWizard.Sidebar.WPS = function (map, sidebar) {
    ...
    wpsPanel = new WRFDomainWizard.Sidebar.WPSPanel($('#container-wps-form', container));
...
WRFDomainWizard.sidebar.wps = function (map, sidebar) {
    return new WRFDomainWizard.Sidebar.WPS(map, sidebar);
}