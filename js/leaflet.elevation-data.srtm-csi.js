...
L.GeoJSON.SRTMCSI = L.GeoJSON.ElevationData.extend({
    ...
    initialize: function (type, tileSize, color) {
        ...
        L.GeoJSON.ElevationData.prototype.initialize.call(this, jsonUrl, color);
    }
});

L.srtmCSI = function (type, tileSize, color) {
    return new L.GeoJSON.SRTMCSI(type, tileSize, color);
};